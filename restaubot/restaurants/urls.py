...
urlpatterns = [
    ...
    path('update/<str:restaurant_id>', views.update_menu_item, name='update restaurant'),
    path('item/<int:restaurant_id>/delete/', views.delete_menu_item, name='delete restaurant'),
]